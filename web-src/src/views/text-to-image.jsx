...
const TextToImage = () => {
  ...
  useEffect(() => {
    dispatch(setCurrentPageName('Text to Image API'));
        ...
        <Flex direction={'column'} height={'100%'}>
            <View height={'100%'}>
                <Flex direction={'row'} height={'100%'}>
                  <View width={'size-3400'}  margin={'size-125'} paddingTop={'size-300'}>
                      <Flex direction={'column'} gap={'size-150'}>
                          ...
                          <Picker label='Style Presets' items={StylePresets} onSelectionChange={onAddPreset}>
                  ...
                  <Flex width={'100%'} height={'100%'} alignItems={'center'} direction={'row'}>
                    <Flex width={'100%'} direction={'column'}  alignItems={'center'}>
                        ...
                        {resultState === 'working' &&
                          <WorkingState message={`Something's happening, I can feel it...`}/>
                        }
                        {resultState === 'done' &&
