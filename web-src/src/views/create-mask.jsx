...
const CreateMask = () => {
  ...
  useEffect(() => {
    dispatch(setCurrentPageName('Create Mask API'));
  ...
  const onGenerate = async() => {
    ...
    const requestData = {
      method: 'POST',
      endpoint: `${PS_BASE_URL}/sensei/mask`,
      headers: {
    ...
    const results = await callPhotoshopAPI('/sensei/mask', body);
                ...
                <Flex direction={'row'} height={'100%'}>
                  ...
                  <Flex width={'100%'} height={'100%'} alignItems={'center'} direction={'row'}>
                    <Flex width={'100%'} direction={'column'}  alignItems={'center'}>
                        ...
                        {resultState === 'working' &&
                          <WorkingState message='Creating masks is fun...'/>
                        }
                        {resultState === 'done' &&
